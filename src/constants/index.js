...
export const ADRESS_MENU = ROOT_ADRESS + 'wp-json/menus/v1/';
...
export const NEWSBOXADDRESS = ADDRESS_V2 + 'posts/?categories=4&per_page=1';
...
export const META_TITLE = 'Jean | JBA Diorama Neither Sci-Fiction nor Reality';*/
